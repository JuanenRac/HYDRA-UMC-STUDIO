// =============================================================================
// HYDRA-UMC STUDIO - React Component: JuanenCNCConfig.tsx
...
/**
 * Executes the  juanen c n c config logic. 
...
export function JuanenCNCConfig() {
  ...
  const handleReset = () => {
    updateRobot(selectedRobot.id, {
      juanenCNC: { enabled: true, size: { width: 500, length: 500 }, worldPos: { x: 0, y: 0 }, worldRot: 0, renderScale: 1 }
    } as any);
  };
