...
const MESH_BASE = '/models/robots-6-dof/wx250s/';
  ...
  return (
    ...
    <group quaternion={WX250S_ROOT_QUAT}>
      <group position={off[0].pos} rotation={off[0].rpy}>
        <mesh geometry={baseGeo} castShadow receiveShadow><meshStandardMaterial {...bodyMat} color={partColors['wx250s_1_base.stl'] ?? bodyMat.color} /></mesh>
      </group>

      <group position={WX250S_CHAIN[0].pos} quaternion={q1}>
        <group position={off[1].pos} rotation={off[1].rpy}>
          <mesh geometry={shoulderGeo} castShadow receiveShadow><meshStandardMaterial {...bodyMat} color={partColors['wx250s_2_shoulder.stl'] ?? bodyMat.color} /></mesh>
        </group>

        <group position={WX250S_CHAIN[1].pos} quaternion={q2}>
          <group position={off[2].pos} rotation={off[2].rpy}>
            <mesh geometry={upperArmGeo} castShadow receiveShadow><meshStandardMaterial {...bodyMat} color={partColors['wx250s_3_upper_arm.stl'] ?? bodyMat.color} /></mesh>
          </group>

          <group position={WX250S_CHAIN[2].pos} quaternion={q3}>
            <group position={off[3].pos} rotation={off[3].rpy}>
              <mesh geometry={upperForearmGeo} castShadow receiveShadow><meshStandardMaterial {...bodyMat} color={partColors['wx250s_4_upper_forearm.stl'] ?? bodyMat.color} /></mesh>
            </group>

            <group position={WX250S_CHAIN[3].pos} quaternion={q4}>
              <group position={off[4].pos} rotation={off[4].rpy}>
                <mesh geometry={lowerForearmGeo} castShadow receiveShadow><meshStandardMaterial {...bodyMat} color={partColors['wx250s_5_lower_forearm.stl'] ?? bodyMat.color} /></mesh>
              </group>

              <group position={WX250S_CHAIN[4].pos} quaternion={q5}>
                <group position={off[5].pos} rotation={off[5].rpy}>
                  <mesh geometry={wristGeo} castShadow receiveShadow><meshStandardMaterial {...bodyMat} color={partColors['wx250s_6_wrist.stl'] ?? bodyMat.color} /></mesh>
                </group>
                ...
                <group position={WX250S_CHAIN[5].pos} quaternion={q6}>
                  ...
                  <group position={off[6].pos} rotation={off[6].rpy}>
                    <mesh geometry={gripperGeo} castShadow receiveShadow><meshStandardMaterial {...bodyMat} color={partColors['wx250s_7_gripper.stl'] ?? bodyMat.color} /></mesh>
