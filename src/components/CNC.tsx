// =============================================================================
// HYDRA-UMC STUDIO - React Component: CNC.tsx
...
export function CNC() {
  ...
  const [machineType, setMachineType] = useState<'juanenCNC'>('juanenCNC');
    ...
    <div className="h-full flex flex-col space-y-4">
      <div className="flex items-center justify-between shrink-0">
        <h2 className="text-lg font-semibold text-slate-100 flex items-center gap-2">
          <PenTool className="text-sky-400" size={20} /> {t('modules.cnc_title', 'CNC')}
        </h2>
        <div className="flex items-center gap-2">
          <select 
            ...
            value={machineType}
            onChange={(e) => setMachineType(e.target.value as 'juanenCNC')}
          >
            <option value="juanenCNC">{t('modules.machine', 'Machine')}: JuanenCNC</option>
          </select>
