    ...
    <div className="h-full flex flex-col space-y-4">
      ...
      {!isEnabled ? (
        <div className="bg-slate-900 border border-slate-800 rounded-lg p-8 flex flex-col items-center justify-center text-center flex-1">
          ...
          <h3 className="text-slate-200 font-medium mb-2">No Vacuum Table Assigned</h3>
          ...
          >
            <Plus size={16} /> Enable Vacuum Table
          </button>
        </div>
      ) : (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 flex-1 min-h-0">
          <div className="space-y-4 overflow-y-auto custom-scrollbar pr-2">
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-lg p-4">
              <h3 className="text-sm font-medium text-slate-200 mb-4">Vacuum Controls</h3>
              <div className="grid grid-cols-2 gap-4">
                ...
                >
                  <Power size={16} /> Pump {moduleData.pumpActive ? 'ON' : 'OFF'}
                </button>
                <button 
                ...
                >
                  <Wind size={16} /> Valve {moduleData.valveActive ? 'OPEN' : 'CLOSED'}
                </button>
              </div>
            </div>
