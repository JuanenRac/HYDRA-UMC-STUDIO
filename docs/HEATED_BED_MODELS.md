...
public/models/heatedbeds/default contains catalog.json, HeatedBed.scad and four preset STL files.
...
~~~sh
openscad --export-format binstl -D bed_width=255 -D bed_length=255 -o public/models/heatedbeds/default/HeatedBed255x255x5mm.stl public/models/heatedbeds/default/HeatedBed.scad
~~~

On Windows use the installed openscad.com with PowerShell's call operator:
~~~powershell
& "C:/Program Files/OpenSCAD/openscad.com" --export-format binstl -D "bed_width=255" -D "bed_length=255" -o "public/models/heatedbeds/default/HeatedBed255x255x5mm.stl" "public/models/heatedbeds/default/HeatedBed.scad"
~~~
...
~~~sh
npm test -- tests/heatedBeds.test.ts
npm run typecheck
npm run build
~~~
